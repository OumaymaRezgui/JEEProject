...
a persistence unit "schoolManagementPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "schoolManagement/pom.xml":
...
artifacts ("schoolManagement-ejb.jar" and "schoolManagement-web.war") are already built. You can build
